 ...
 * @enum {string}
 */
export declare enum AccountingEventType {
    Star = "*",
...
export declare function AccountingEventTypeFromJSON(json: any): AccountingEventType;
export declare function AccountingEventTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): AccountingEventType;
export declare function AccountingEventTypeToJSON(value?: AccountingEventType | null): any;
